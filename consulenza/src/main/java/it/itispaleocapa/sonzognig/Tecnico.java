...
public class Tecnico extends Personale{
    ...
    public class specializazzioneNonValidaException extends Exception{};
    public class statoNonValidoException extends Exception{};

    String specializazzione, stato;
    public Tecnico(String nome, String cognome, String codice, int annoAssunzione, String specializzazione, String stato) throws AnnoNonValidoException, statoNonValidoException, specializazzioneNonValidaException {
        super(nome, cognome, codice, annoAssunzione);
        if(specializzazione != "info_tele" && specializzazione != "elett_auto"){
            throw new specializazzioneNonValidaException();
        }
